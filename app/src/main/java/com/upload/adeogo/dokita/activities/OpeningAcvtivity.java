...
public class OpeningAcvtivity extends AppCompatActivity {
    ...
    private RelativeLayout mNameRelativeLayout, mSpecialityRelativeLayout, mCityRelativeLayout;
    ...
    private ImageView mSpecialityImageView, mClearCity, mClearName, mClearSpeciality, mCityImageView, mNameImageView, mProfileImageView, mQuestionImageView;

    private String mChosenDoctorName = null, mChosenCity = null, mChosenSpeciality = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mClearCity = findViewById(R.id.clearCity);
        mClearName = findViewById(R.id.clearName);
        mClearSpeciality = findViewById(R.id.clearSpeciality);
...
//        });
    ...
    private void setClearListeners() {
        mClearSpeciality.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mChosenSpeciality = null;
                checkStates();
            }
        });

        mClearCity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mChosenCity = null;
                checkStates();
